// Ported verbatim from pi-diff-review (https://github.com/badlogic/pi-diff-review)
// Original: src/prompt.ts. No external deps.
...
function getCommentFilePath(file, scope) {
